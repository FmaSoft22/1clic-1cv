...
use App\Domains\FmaDomBusiness\Candidates\Career;
...
class CandidateService implements ICandidateService
{
    ...
    protected function __construct(ManagerRegistry $_registry){
        $registry = $_registry;
    }
    protected function __clone(){
    }

    public static function getInstance(ManagerRegistry $registry):ICandidateService{
        if(is_null(self::$_instance)){
            self::$_instance = new CandidateService($registry);
        }
    ...
    public function GetCandidate(string $candidateID):Candidate{
       ...
       public function GetCareer(int $careerID,int $candidateID){
           $career = new Career(54,'Ingénieur Logiciel Full Stack','Participer au dévéloppement des applications logiciels et assurer la maintenance',
           54,'Immédiat','CDI','CDI','de 20000 à 25000  euros',null,null,1,'Je suis un génie');
           return $career;
       }
